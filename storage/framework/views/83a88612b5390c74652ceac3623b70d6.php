...
<div class="container-fluid mt-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary rounded-pill px-4" <?php echo e($isLimitReached ? 'disabled' : ''); ?> data-bs-toggle="modal" data-bs-target="#createBlogModal">
        ...
        <div class="table-responsive">
            <table id="blogTable" class="table table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($blogs->firstItem() + $i); ?></td>
                        <td><?php echo e(Str::limit($blog->title, 60)); ?></td>
                        <td><span class="badge <?php echo e($blog->is_published ? 'bg-success' : 'bg-secondary'); ?>"><?php echo e($blog->is_published ? 'Published' : 'Draft'); ?></span></td>
                        <td>
                            <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#editBlogModal<?php echo e($blog->id); ?>"><i class="bi bi-pencil"></i></button>
                            <form method="POST" action="<?php echo e(route('tenant.admin.blogs.destroy', ['tenant' => $tenant->subdomain, 'blog' => $blog])); ?>" class="d-inline" onsubmit="return confirm('Delete this blog?')">
    ...
    <!-- Edit Blog Modal -->
    <div class="modal fade" id="editBlogModal<?php echo e($blog->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-start">
                    <form action="<?php echo e(route('tenant.admin.blogs.update', ['tenant' => $tenant->subdomain, 'blog' => $blog])); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" class="form-control" rows="6" required><?php echo e($blog->content); ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_published" class="form-select w-100" required>
                                <option value="1" <?php echo e($blog->is_published ? 'selected' : ''); ?>>Published</option>
                                <option value="0" <?php echo e(!$blog->is_published ? 'selected' : ''); ?>>Draft</option>
                            </select>
                        </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('tenant.admin.blogs.store', ['tenant' => $tenant->subdomain])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tertgxyp/public_html/acadsuite/resources/views/tenant/admin/blogs.blade.php ENDPATH**/ ?>