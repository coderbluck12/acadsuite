            ...
            <nav class="navbar navbar-expand-md border border-white rounded-5 glass-navbar px-4 py-2 w-100" style="background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
                    <ul class="navbar-nav gap-2" id="mainTab" role="tablist">
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.home', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5" style="color: inherit; text-decoration: none;">Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.publications', ['tenant' => $tenant->subdomain])); ?>" class="nav-link active rounded-5" style="color: inherit; text-decoration: none; background-color: #dc3545; padding-inline: 20px;">Publications</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.resources', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5" style="color: inherit; text-decoration: none;">Resources</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.blogs', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5" style="color: inherit; text-decoration: none;">Blogs</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.courses', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5" style="color: inherit; text-decoration: none;">Courses</a>
                        </li>
    ...
    <section>
        <div class="container my-5 px-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('tenant.login', ['tenant' => $tenant->subdomain])); ?>" class="btn btn-primary">
            ...
            <div class="row g-4" id="publicationsList">
                ...
                <div class="col-12 publication-card" data-title="<?php echo e(strtolower($publication->title)); ?>">
                    <div class="card shadow-lg border-0 p-3">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted mb-3"><?php echo e($publication->authors ?? $tenant->owner_name); ?></h6>
                            <div class="small text-secondary mb-3">
                                <i class="bi bi-calendar-check me-1"></i>
                                <strong>Published:</strong> <?php echo e($publication->published_at ? $publication->published_at->format('Y') : $publication->created_at->format('Y')); ?>

                            </div>
                            <p class="card-text">
                                <?php echo e(Str::limit($publication->abstract ?? $publication->description, 200)); ?>
                        ...
                        <div class="card-footer bg-white border-0 pt-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(asset('storage/' . $publication->file_path)); ?>" target="_blank" class="btn btn-success btn-sm">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\acadsuite\resources\views/tenant/public/publications.blade.php ENDPATH**/ ?>