...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero" style="position: relative; background: url('<?php echo e(asset('assets/publications.jpg')); ?>') center/cover no-repeat; height: 60vh; display: flex; align-items: center; justify-content: center; color: white;">
            ...
            <nav class="navbar navbar-expand-md border border-white rounded-5 glass-navbar px-4 py-2 w-100" style="background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
                    <ul class="navbar-nav gap-2" id="mainTab" role="tablist">
                        ...
                        <li class="nav-item"><a href="<?php echo e(route('tenant.blogs', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5" style="color: inherit; text-decoration: none;">Blogs</a></li>
                        <li class="nav-item"><a href="<?php echo e(route('tenant.courses', ['tenant' => $tenant->subdomain])); ?>" class="nav-link active rounded-5" style="color: inherit; text-decoration: none; background-color: #dc3545; padding-inline: 20px;">Courses</a></li>
        ...
        <div class="hero-content" style="position: relative; z-index: 2; text-align: center;">
            <h6 class="display-3 fw-bold" id="courseTitle"><?php echo e($course->title); ?></h6>
    ...
    <section class="container py-5">
        <div class="card shadow-lg border-0 p-4">
            <div class="card-body">
                ...
                <?php if($course->link): ?>
                    <div class="mt-4 mb-4">
                        <a href="<?php echo e($course->link); ?>" target="_blank" class="btn btn-primary btn-lg px-4 rounded-pill">
        ...
        <div class="mt-5 text-center">
            <a href="<?php echo e(route('tenant.courses', ['tenant' => $tenant->subdomain])); ?>" class="btn btn-outline-secondary rounded-pill px-4">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\acadsuite\resources\views/tenant/public/course-show.blade.php ENDPATH**/ ?>