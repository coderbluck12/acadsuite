    ...
    <div class="row h-100">
        ...
        <div class="col-md-4 form-section">
            <div class="login-container">
                ...
                <form method="POST" action="<?php echo e(route('tenant.login.post', ['tenant' => $tenant->subdomain])); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="text-center mt-3">
                        <p class="mb-0">Don't have an account yet?
                            <a href="<?php echo e(route('tenant.register', ['tenant' => $tenant->subdomain])); ?>" class="fw-semibold text-decoration-none">Sign up</a>
                        </p>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\acadsuite\resources\views/tenant/auth/login.blade.php ENDPATH**/ ?>