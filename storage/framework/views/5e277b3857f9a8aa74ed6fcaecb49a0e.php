...
<nav class="navbar navbar-expand-lg navbar-dark" style="background:rgba(26,35,126,0.95);backdrop-filter:blur(8px);position:fixed;top:0;width:100%;z-index:1000;">
    <div class="container">
        <a class="navbar-brand fw-bold fs-5" href="<?php echo e(route('landing.home')); ?>">
            <img src="<?php echo e(asset('assets/logo.png')); ?>" height="40" class="me-2" alt="AcadSuite">
            AcadSuite
        </a>
        ...
        <div class="collapse navbar-collapse" id="landingNav">
            <ul class="navbar-nav ms-auto gap-2">
                ...
                <li class="nav-item"><a href="<?php echo e(route('landing.register')); ?>" class="btn btn-warning rounded-pill px-4 fw-semibold ms-2">Create Your Suite →</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="container py-5 mt-4">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <p class="lead opacity-90 mb-5">Create a fully branded subdomain for your research, publications, courses, and student management. Trusted by <strong class="count-badge"><?php echo e($totalAcademics); ?></strong> academics worldwide.</p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('landing.register')); ?>" class="btn btn-warning btn-hero rounded-pill">🚀 Create Your Suite — Free</a>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 p-4">
                    <div class="feature-icon <?php echo e($feature['color']); ?> bg-opacity-10 mb-3">
                        <i class="bi <?php echo e($feature['icon']); ?> <?php echo e($feature['color']); ?>"></i>
                    </div>
                    <h5 class="fw-bold"><?php echo e($feature['title']); ?></h5>
                    <p class="text-muted mb-0"><?php echo e($feature['desc']); ?></p>
                </div>
            </div>
...
<section id="how-it-works" class="py-5">
    <div class="container py-4 text-center">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = [['1','Register & Choose Subdomain','Pick your unique subdomain (e.g., yourname.acadsuite.com) and fill your details.'],['2','Set Up Your Suite','Login to your admin panel, update your profile, and start adding publications, courses, and resources.'],['3','Share with the World','Your portal is live instantly. Share the link with students, colleagues, and the world.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$step,$title,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4">
                <div class="card border-0 bg-light h-100 p-4">
                    <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center mx-auto mb-3 fw-bold" style="width:52px;height:52px;font-size:1.3rem;"><?php echo e($step); ?></div>
        ...
        <div class="mt-5">
            <a href="<?php echo e(route('landing.register')); ?>" class="btn btn-primary btn-lg rounded-pill px-5 py-3 fw-semibold shadow">Create Your Suite Now — It's Free 🎓</a>
        </div>
    </div>
</section>
...
<footer class="bg-dark text-light py-4">
    <div class="container text-center">
        ...
        <small class="opacity-50">&copy; <?php echo e(date('Y')); ?> Pentagonware. All rights reserved.</small>
    </div>
</footer>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tertgxyp/public_html/acadsuite/resources/views/landing/home.blade.php ENDPATH**/ ?>