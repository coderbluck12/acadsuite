    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden">
                <div class="card-header bg-<?php echo e($tenant->plan === 'pro' ? 'primary' : 'dark'); ?> text-white py-3 border-0">
                    <h6 class="text-uppercase small fw-bold mb-0 opacity-75">Your Current Plan</h6>
                </div>
                <div class="card-body p-4 text-center">
                    <div class="display-5 fw-bold mb-1 text-<?php echo e($tenant->plan === 'pro' ? 'primary' : 'dark'); ?>">
                        <?php echo e($tenant->plan === 'pro' ? 'Pro' : 'Free'); ?>

                    </div>
                    <div class="fs-4 text-muted mb-4">
                        <?php echo e($tenant->plan === 'pro' ? '$50' : '$0'); ?><span class="fs-6">/month</span>
                    </div>
                    
                    <?php if($tenant->plan === 'pro'): ?>
                            ...
                            <div class="p-3 border rounded-3 bg-light bg-opacity-50">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="rounded-circle bg-white shadow-sm p-2 me-2 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                        <i class="bi bi-<?php echo e($item['icon']); ?> text-primary"></i>
                                    </div>
                                    <span class="fw-bold small"><?php echo e($item['label']); ?></span>
                                </div>
                                <div class="d-flex justify-content-between align-items-end">
                                    <div class="fs-4 fw-bold"><?php echo e($item['count']); ?></div>
                                    <div class="text-muted small mb-1">
                                        <?php if($tenant->plan === 'pro'): ?>
                                            Unlimited
                                        <?php else: ?>
                                            <?php echo e($item['count']); ?>/<?php echo e($limit); ?> used
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <?php if($tenant->plan !== 'pro'): ?>
                                    <div class="progress mt-2" style="height: 6px;">
                                        <?php $percent = ($item['count'] / $limit) * 100; ?>
                                        <div class="progress-bar bg-<?php echo e($percent >= 100 ? 'danger' : ($percent >= 80 ? 'warning' : 'primary')); ?>" 
                                             role="progressbar" style="width: <?php echo e(min($percent, 100)); ?>%"></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tertgxyp/public_html/acadsuite/resources/views/tenant/admin/plans.blade.php ENDPATH**/ ?>