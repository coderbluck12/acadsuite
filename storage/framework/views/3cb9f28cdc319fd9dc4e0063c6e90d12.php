...
<div class="container-fluid mt-2">
            ...
            <table id="resTable" class="table table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#editResModal<?php echo e($res->id); ?>"><i class="bi bi-pencil"></i></button>
    ...
    <!-- Edit Resource Modal -->
    <div class="modal fade" id="editResModal<?php echo e($res->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-start">
                    <form action="<?php echo e(route('tenant.admin.resources.update', ['tenant' => $tenant->subdomain, 'resource' => $res])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Resource Title</label>
                            <input type="text" name="title" class="form-control" value="<?php echo e($res->title); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Description</label>
                            <textarea class="form-control" name="description"><?php echo e($res->description); ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_published" class="form-select w-100" required>
                                <option value="1" <?php echo e($res->is_published ? 'selected' : ''); ?>>Published</option>
                                <option value="0" <?php echo e(!$res->is_published ? 'selected' : ''); ?>>Draft</option>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tertgxyp/public_html/acadsuite/resources/views/tenant/admin/resources.blade.php ENDPATH**/ ?>