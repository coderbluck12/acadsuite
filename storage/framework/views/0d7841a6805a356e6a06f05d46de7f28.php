...
<?php $__env->startSection('content'); ?>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <nav class="navbar navbar-expand-md border border-white rounded-5 glass-navbar px-4 py-2 w-100">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
                    <ul class="navbar-nav gap-2" id="mainTab" role="tablist">
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.home', ['tenant' => $tenant->subdomain])); ?>" class="nav-link active rounded-5 decoration-0"
                                style="color: inherit; text-decoration: none;">Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.publications', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5 decoration-0"
                                style="color: inherit; text-decoration: none;">Publications</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.resources', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5 decoration-0"
                                style="color: inherit; text-decoration: none;">Resources</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.blogs', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5 decoration-0"
                                style="color: inherit; text-decoration: none;">Blogs</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.courses', ['tenant' => $tenant->subdomain])); ?>" class="nav-link rounded-5 decoration-0"
                                style="color: inherit; text-decoration: none;">Courses</a>
                        </li>
                        <?php if($tenant->orcid_url): ?>
                        <li class="nav-item">
                            <a href="<?php echo e($tenant->orcid_url); ?>" target="_blank" class="nav-link rounded-5 decoration-0"
                                style="color: inherit; text-decoration: none;">ORCID</a>
                        </li>
                        <?php endif; ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('tenant.login', ['tenant' => $tenant->subdomain])); ?>" class="btn btn-primary rounded-pill px-3 py-1 ms-2">Login</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active position-relative">
                <?php if($tenant->avatar): ?>
                    <img src="<?php echo e(asset('storage/' . $tenant->avatar)); ?>" class="d-block w-100" alt="Slide 1" />
                <?php else: ?>
                    <img src="<?php echo e(asset('assets/boy.jpeg')); ?>" class="d-block w-100" alt="Slide 1" />
                <?php endif; ?>
                ...
                <div class="carousel-caption d-flex flex-column justify-content-center align-items-start text-start h-100"
                    ...
                    <p class="lead text-white mb-4 text-wrap" style="max-width: 800px;">
                        Researcher and educator, founder of <strong><?php echo e($tenant->name); ?></strong>,
            ...
            <div class="carousel-item position-relative">
                <img src="<?php echo e(asset('assets/group_students.jpeg')); ?>" class="d-block w-100" alt="Slide 2" />
                <div class="overlay"></div>
                <div class="carousel-caption d-flex flex-column justify-content-center align-items-start text-start h-100"
                    style="transform: translateY(70px);">
                    ...
                    <a href="<?php echo e(route('tenant.courses', ['tenant' => $tenant->subdomain])); ?>" class="btn btn-primary rounded-pill px-4 py-2">Explore Now</a>
                </div>
            </div>

            <!-- Slide 3 -->
            <div class="carousel-item position-relative">
                <img src="<?php echo e(asset('assets/studious_gril.jpg')); ?>" class="d-block w-100" alt="Slide 3" />
                <div class="overlay"></div>
                <div class="carousel-caption d-flex flex-column justify-content-center align-items-start text-start h-100"
                    style="transform: translateY(70px);">
                    ...
                    <a href="<?php echo e(route('tenant.register', ['tenant' => $tenant->subdomain])); ?>" class="btn btn-primary rounded-pill px-4 py-2">Get Started</a>
                </div>
            </div>
        </div>
    ...
    <div class="container my-5 p-5 rounded" id="owner"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-4 text-center mb-4 mb-lg-0">
                <?php if($tenant->avatar): ?>
                    <img src="<?php echo e(asset('storage/' . $tenant->avatar)); ?>" alt="<?php echo e($tenant->owner_name); ?>" class="owner-img shadow-lg">
                <?php else: ?>
                    <img src="<?php echo e(asset('assets/boy.jpeg')); ?>" alt="<?php echo e($tenant->owner_name); ?>" class="owner-img shadow-lg">
                <?php endif; ?>
            </div>

            <!-- Owner Details -->
            <div class="col-12 col-lg-8">
                <h2 class="fw-bold mb-2"><?php echo e($tenant->owner_name); ?></h2>
                <h5 class="text-muted mb-3">Researcher & Founder</h5>
                <p class="lead fs-6"><?php echo e(Str::limit($tenant->bio, 180)); ?></p>

                <!-- CTA Buttons -->
                <div class="d-flex flex-wrap gap-3 mt-4">
                    <?php if($tenant->phone): ?>
                    <a href="tel:<?php echo e($tenant->phone); ?>" class="btn btn-danger rounded-pill px-4">
                        Contact
                    </a>
                    <?php endif; ?>
                    <?php if($tenant->orcid_url): ?>
                    <a href="<?php echo e($tenant->orcid_url); ?>" target="_blank" class="btn btn-secondary rounded-pill px-4">
                        ORCID
                    </a>
                    <?php endif; ?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content rounded-4 shadow-lg m-2">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="aboutModalLabel">About <?php echo e($tenant->owner_name); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <p class="lead fs-5" id="bio-full"><?php echo nl2br(e($tenant->bio)); ?></p>
                </div>
    ...
    <section class="container mb-5" id="box_overlay">
        <div class="row g-5">
            ...
            <div class="col-12 col-lg-5 text-center text-lg-end px-5">
                <img src="<?php echo e(asset('assets/library.jpeg')); ?>" alt="What we offer" class="img-fluid rounded shadow"
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm h-100">
                        <?php if($blog->cover_image): ?>
                            <img src="<?php echo e(asset('storage/' . $blog->cover_image)); ?>" class="card-img-top" alt="Blog Image" style="height: 200px; object-fit: cover;">
                        <?php else: ?>
                            <img src="<?php echo e(asset('assets/young-student-learning-library.jpg')); ?>" class="card-img-top" alt="Blog Image" style="height: 200px; object-fit: cover;">
                        <?php endif; ?>
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><?php echo e($blog->title); ?></h5>
                            <p class="card-text flex-grow-1"><?php echo e(Str::limit($blog->excerpt ?? wp_strip_all_tags($blog->content), 100)); ?></p>
                            <div class="mt-auto">
                                <a href="<?php echo e(route('tenant.blogs.show', ['tenant' => $tenant->subdomain, 'blog' => $blog->id])); ?>" class="btn btn-outline-primary btn-sm">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- WHAT STUDENTS SAY -->
    <section class="py-5 position-relative text-white" id="testimonial" style="background-image: url('<?php echo e(asset('assets/young-student-learning-library.jpg')); ?>');">
        <!-- Red Overlay -->
            ...
            <div class="container row mx-auto g-4 justify-content-center" style="overflow-x: hidden;">
                ...
                <div class="col-md-5">
                    <div class="bg-white text-dark p-4 rounded shadow">
                        <img src="<?php echo e(asset('assets/girl.jpeg')); ?>" alt="Student Photo" class="rounded-circle mx-auto d-block mb-3"
                ...
                <div class="col-md-5">
                    <div class="bg-white text-dark p-4 rounded shadow">
                        <img src="<?php echo e(asset('assets/boy.jpeg')); ?>" alt="Student Photo" class="rounded-circle mx-auto d-block mb-3"
                            style="width: 100px; height: 100px; object-fit: cover;">
        ...
        <div class="container py-5 px-5">
            <div class="row align-items-center" style="overflow-x: hidden;">
                ...
                <div class="col-lg-6">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('tenant.resource.request', ['tenant' => $tenant->subdomain])); ?>" method="POST" class="row g-3 g-lg-4 justify-content-center">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-6 ">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php if($tenant->orcid_url): ?>
                        <li><a href="<?php echo e($tenant->orcid_url); ?>" target="_blank" class="text-light text-decoration-none">ORCID</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div>
                        <?php if(!empty($tenant->social_links['twitter'])): ?>
                        <a href="<?php echo e($tenant->social_links['twitter']); ?>" class="text-light me-3 fs-5" target="_blank">
                            <span class="iconify" data-icon="mdi:twitter"></span>
                        </a>
                        <?php endif; ?>
                        <?php if(!empty($tenant->social_links['facebook'])): ?>
                        <a href="<?php echo e($tenant->social_links['facebook']); ?>" class="text-light me-3 fs-5" target="_blank">
                            <span class="iconify" data-icon="mdi:facebook"></span>
                        </a>
                        <?php endif; ?>
                        <?php if(!empty($tenant->social_links['instagram'])): ?>
                        <a href="<?php echo e($tenant->social_links['instagram']); ?>" class="text-light fs-5" target="_blank">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\acadsuite\resources\views/tenant/public/home.blade.php ENDPATH**/ ?>