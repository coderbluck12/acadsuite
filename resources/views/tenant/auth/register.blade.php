    ...
    <div class="row h-100">
        ...
        <div class="col-md-4 form-section">
            <div class="login-container">
                ...
                <form method="POST" action="{{ route('tenant.register.post', ['tenant' => $tenant->subdomain]) }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="text-center mt-3">
                        <p class="mb-0">Already have an account?
                            <a href="{{ route('tenant.login', ['tenant' => $tenant->subdomain]) }}" class="fw-semibold text-decoration-none">Login</a>
                        </p>
                    </div>
                </form>
                
                <div class="mt-4 small text-muted text-center">&copy; {{ date('Y') }}. ALL RIGHTS RESERVED.</div>
            </div>
        </div>
    </div>
</div>
